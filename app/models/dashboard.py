...
class Dashboard(Base):
    ...
    executive_summary_kpis = Column(JSON, default=list)   # List[ExecutiveSummaryKpiItem]
    dashboard_charts       = Column(JSON, default=list)   # List[DashboardChartItem]

    # RAG debug metadata (stored when debug=True was requested)
