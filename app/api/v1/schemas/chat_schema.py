...
# Strict chart-type enum so the frontend can switch without string matching
...
class ChartSpec(BaseModel):
    ...
    title: str
    caption: str
    data: Dict[str, Any] = Field(default_factory=dict)  # columnar: {x:[...], y:[...]}
...
class ToolStartEvent(BaseModel):
    tool: str           # AllowedOp value
    args_summary: str   # human-readable one-liner, not raw args


class ToolResultEvent(BaseModel):
    preview: str        # ≤ 500 chars stringified slice of result
