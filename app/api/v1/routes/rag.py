...
async def _get_owned_dashboard_or_404(
    ...
    await _get_owned_dataset_or_404(db, dashboard.dataset_id, current_user)
    ...
    if save:
        ...
        try:
            ...
            dashboard = await run_rag_insights_and_save(
                ...
                db, dataset_id, user_id=current_user.user_id, debug=debug
...
async def execute_dashboard(
    ...
    dashboard = await _get_owned_dashboard_or_404(db, dashboard_id, current_user)
